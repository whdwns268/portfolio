...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		showMonthAfterYear: true, // 년 월 위치변경
		yearSuffix: "", // Additional text to append to the year in the month headers,
		selectMonthLabel: "Select month", // Invisible label for month selector
		selectYearLabel: "Select year" // Invisible label for year selector
	};
	this._defaults = { // Global defaults for all the date picker instances
		showOn: "both", // 포커스 시 팝업, button - 버튼 클릭 시 팝업, both - 포커스나 버튼 클릭 시 팝업 중 선택
		showAnim: "slideDown", // 팝업 애니메이션의 이름
		showOptions: {}, // Options for enhanced animations
		defaultDate: null, // Used when field is blank: actual date,
			// +/-number for offset from today, null for today
		appendText: "", // Display text following the input box, e.g. showing the format
		buttonText: "...", // Text for trigger button
		buttonImage: "./cal.svg", // URL for trigger button image
		...
		changeMonth: true, // select로 월을 선택하는 부분
		changeYear: true, // select로 년도를 선택하는 부분
		yearRange: "c-10:c+10", //년도 기간 범위 선택 부분
		...
		minDate: new Date(), // new Date() 오늘 날짜를 선택
		maxDate: 7, // 오늘날짜기준 +7일까지만 선택
		...
		showButtonPanel: false, // "True"는 버튼 패널을 표시하고 "false"는 버튼 패널을 표시하지 않는 것을 의미합니다.
		autoSize: true, // 날짜가 입력되는 input이 자동 조절됨
